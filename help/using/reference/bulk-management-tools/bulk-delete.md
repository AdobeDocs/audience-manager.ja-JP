---
description: 一括削除を使用すると、1回の操作で複数のセグメント、特性、フォルダー、派生シグナル、データソース、モデルおよび宛先を削除できます。 一括削除リクエストをおこなうには、以下の手順に従ってください。
seo-description: 一括削除を使用すると、1回の操作で複数のセグメント、特性、フォルダー、派生シグナル、データソース、モデルおよび宛先を削除できます。 一括削除リクエストをおこなうには、以下の手順に従ってください。
seo-title: 一括削除
...
一括削除を使用すると、1回の操作で複数のセグメント、特性、フォルダー、派生シグナル、データソース、モデルおよび宛先を削除できます。 一括削除リクエストをおこなうには、以下の手順に従ってください。
