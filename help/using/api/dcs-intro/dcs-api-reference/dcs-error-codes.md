...
# DCS エラー コード、メッセージ、例 {#dcs-error-codes-messages-and-examples}
...
<table id="table_31F1593C46804DDBA2E9BEDE83F2417F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Customer id was discarded because it exceeded the limit for a given namespace.Namespace id is<code><i>ID</i></code>、顧客IDは <code><i>ID</i></code>。 </p> </td> 
  ...
  <tr> 
   ...
   <p>Explanation: An <span class="keyword">IDFA (DPID 20915)</span> must be an uppercase ID. 例の要求では ID を小文字で指定しています。</p>
   </td>
  </tr>
