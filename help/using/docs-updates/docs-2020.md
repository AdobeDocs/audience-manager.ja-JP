...
| [Audience ManagerREST APIの使用の手引き](/help/using/api/rest-api-main/aam-api-getting-started.md#jwt) | を使用する **JWT（サービスアカウント）認証の節を新たに追加し[!DNL Adobe I/O]**ました。 を使用してAudience ManagerAPIに対する認証を行うには、この節を参照してく[!DNL Adobe I/O]ださい。 |
