...
| トピック | 説明 |
|---- |----|
| [管理](../features/administration/administration-overview.md#use-cases) | 役割ベースのアクセス制御(RBAC)のドキュメントに2つの使用例を追加し、Audience Managerの管理をより簡単にする方法を理解する [!DNL RBAC] ために役立ちました。 |
