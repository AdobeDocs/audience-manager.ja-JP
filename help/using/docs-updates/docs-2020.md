...
| [Adobe Analytics から Audience Manager にデータを転送する方法 ](../integration/integration-other-solutions/audience-management-module.md) | このページを更新し、Adobe AnalyticsからAudience Managerにデータを転送する推奨される方法として、「Adobe Experience Platform Launch」を強調しました。 |
