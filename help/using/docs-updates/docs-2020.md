...
| トピック | 説明 |
|---- |----|
| [Audience Manager のアクセシビリティ](../overview/accessibility-in-aam.md) | アクセシビリティとは、視覚、聴覚、認知、運動など、様々な障碍のあるユーザーが、できる限り労力を費やすことなしに、ソフトウェア製品を使用できるようにする一連の機能を指します。Audience Manager を誰にとってもより使いやすいものにするために、アドビでは、この記事で詳しく説明する、複数のアクセシビリティ機能をサポートしています。 |
