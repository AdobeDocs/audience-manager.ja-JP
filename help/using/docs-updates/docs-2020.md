...
| [Adobe Analytics から Audience Manager にデータを転送する方法 ](../integration/integration-other-solutions/audience-management-module.md) | このページは、Adobe Experience PlatformタグをAdobe AnalyticsからAudience Managerにデータを転送する推奨方法として取り上げるように更新されました。 |
