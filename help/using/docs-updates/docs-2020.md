...
| トピック | 説明 |
|---- |----|
| [Adobe Experience PlatformでのAudience Managerデータエクスポートコントロールのサポート](/help/using/integration/integration-aep/aam-aep-audience-sharing.md#aam-data-export-control-in-aep) | 「Audience ManagerとAdobe Experience Platformの間でのオーディエンス共有」の記事の新しい節には、Audience Managerデータの書き出しコントロールとExperience Platformデータの使用ラベルの対応付けが含まれています。 |
