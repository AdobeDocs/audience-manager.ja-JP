...
| <ul><li>[セグメントビルダー](/help/using/features/segments/segment-builder.md)</li><li>[オーディエンスマーケットプレイスでのセグメントレベルのレポート](/help/using/features/audience-marketplace/marketplace-data-buyers/marketplace-buyer-billing.md)</li><li>[特性サマリ表示のオーディエンスIDレポート ](/help/using/features/traits/trait-details-page.md)</li><li>[セグメントサマリ表示のオーディエンスIDレポート ](/help/using/features/segments/segment-summary-view.md)</li><li>[コンバージョン特性の作成方法](/help/using/features/traits/create-onboarded-rule-based-traits.md)</li><li>[特性レコメンデーション](/help/using/features/segments/trait-recommendations.md)</li></ul> | Audience Manager のドキュメントで複数のページにチュートリアルビデオを追加しました。 |
