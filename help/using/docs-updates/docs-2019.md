...
| トピック | 説明 |
|--- |----|
| [一括管理ツール](/help/using/reference/bulk-management-tools/bulk-management-intro.md) | MacOSおよびMicrosoft Windowsオペレーティングシステムで動作し、Experience cloudログインをサポートする新しいバージョンのバルク管理ワークシートがリリースされました。 |
