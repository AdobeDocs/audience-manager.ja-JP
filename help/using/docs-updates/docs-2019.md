...
| トピック | 説明 |
|--- |----|
| [最新性と頻度](/help/using/features/segments/recency-and-frequency.md) | We updated the frequency capping examples in the article and added examples for how recency works. |
