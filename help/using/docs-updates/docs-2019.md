...
| トピック | 説明 |
|--- |----|
| * Segment Builder [*](/help/using/features/segments/segment-builder.md) * Segment-level Reporting in Audience Marketplace * <br> Audience Audience Reporting概要表示で報告ID概要表示ID概要表示ID概要表示 [](/help/using/features/audience-marketplace/marketplace-data-buyers/marketplace-buyer-billing.md)<br>[](/help/using/features/traits/trait-details-page.md)<br>[](/help/using/features/segments/segment-summary-view.md)<br>[](/help/using/features/traits/create-onboarded-rule-based-traits.md)<br>[*概要説明ID概要推奨](/help/using/features/segments/trait-recommendations.md) | Audience Managerのドキュメントで、複数のページにチュートリアルビデオを追加しました。 |
