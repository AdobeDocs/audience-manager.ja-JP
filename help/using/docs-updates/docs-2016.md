...
<table id="table_B19586DBA5D44F8E9D06610DB704EFB9"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <i>この機能は廃止されました。</i><p><span class="keyword">Adobe Experience Cloud Device Co-op</span> の詳しい説明を追加しました。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_9B18916DD43E4DB38C0C340DE4E3DF62"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <a href="https://experienceleague.adobe.com/docs/core-services/interface/ec-cookies/cookies-am.html?lang=ja" format="https" scope="external"> Experience Cloud で使用される Cookie</a> </td> 
   <td colname="col2"> フランスの CNIL による法規制を遵守するために、demdex Cookie とパートナー Cookie の有効期間（TTL）値を 180 日に変更しました。 </td> 
  </tr> 
  <tr> 
...
<table id="table_50CD90671E4B4C50A624AC0948FA8324"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>DIL で <code> GET</code> および <code> POST</code> メソッドを使用してイベント呼び出しでデータを送信する理由を説明するために内容を更新しました。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_E71252DF328F42A3AB0BD2CA7DC5A549"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>モバイル ID を <code> d_cid</code> で渡す説明を追加して更新しました。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../reference/beta-environment.md"> Beta 環境 </a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Beta 環境のホスト名を更新しました。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_106BAD4680F1446B813A907F9E3ADCB8"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="https://experienceleague.adobe.com/docs/audience-manager/user-guide/implementation-integration-guides/integration-experience-platform/aam-aep-audience-sharing.html?lang=ja" format="https" scope="external"> Analytics での Audience Manager セグメント</a> </p> </td> 
...
<table id="table_AC8FF0DB45B546C69D89749FF0FA1CCD"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>テキストを更新して、特性とセグメントの 30 日間合計の違いについての説明を追加しました。 </p> </td> 
  </tr> 
  <tr> 
