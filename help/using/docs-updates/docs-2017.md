...
<table id="table_020B4F263E1C4C55BDF10B15436B0471"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="https://docs.adobe.com/content/help/en/core-services/interface/more-resources/dns-prefetch.html" format="https" scope="external"> 様々な Experience Cloud ソリューションによる DNS プリフェッチの使用</a> </p> </td> 
...
Links to [!DNL Audience Manager] release notes and documentation changes. For an archive of older changes at the [!DNL Experience Cloud] level, see the [Previous Release Notes](https://docs.adobe.com/content/help/ja-JP/release-notes/experience-cloud/current.html) section.
