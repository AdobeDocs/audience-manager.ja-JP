...
<table id="table_366914EEDA294636A580F706AFC57ACC"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="https://marketing.adobe.com/resources/help/en_US/whitepapers/cookies/cookies_am.html" format="https" scope="external"> Audience Manager の Cookie</a> </p> </td> 
...
<table id="table_6AAE9EF4DE76467FAFEDAB418B5A0207"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../features/traits/trait-qualification-reference.md"> トレートの認定に関するリファレンス</a> </p> </td> 
   <td colname="col2"> <p>Audience Manager では、特性の絞り込み（特性の満足）の処理方法は特性のタイプによって異なります。このドキュメントでは、特性のタイプごとに絞り込みの詳細を説明しています。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../faq/faq-privacy.md"> プライバシーとデータ保持の FAQ</a> </p> </td> 
...
<table id="table_18C3AA0411CC4CBC98531BE735934E30"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p><a href="../api/dcs-intro/dcs-api-reference/dcs-error-codes.md"> DCS エラー コード、メッセージ、例</a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../faq/faq-reporting.md"> レポートの FAQ</a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../features/destinations/manage-destinations.md"> Analytics の宛先の設定</a> </p> </td> 
...
<table id="table_8BA284C2CD324D5F988D9209D9078BE1"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../faq/faq-data-collection.md"> データ収集と製品統合の FAQ</a> </p> </td> 
   <td colname="col2"> <p>宣言済み ID を含んだイベント呼び出しを DCS に送信する場合の不明な特性の認識に関する質問を追加しました。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../integration/media-data-integration/actionable-log-files.md"> 実用的なログファイル</a> </p> </td> 
   <td colname="col2"> <p>DCM ログファイルを <span class="keyword">Audience Manager</span> にインポートする方法として<span class="wintitle">実用的なログファイル</span>が推奨される理由と、この機能を導入する方法を説明します。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../reporting/audience-optimization-reports/aor-advertisers/import-dcm.md"> DCM データファイルを Audience Manager にインポート</a> </p> </td> 
   <td colname="col2"> <p><span class="wintitle">Audience Manager</span> への DCM データファイルのインポートをセットアップした後で<span class="keyword">実用的なログファイル</span>を有効にするために必要な手順 7 を追加しました。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../features/traits/trait-details-page.md"> 特性詳細ページ</a> </p> </td> 
   <td colname="col2"> <p>特性詳細ページの機能（特性監査ログなど）を説明する新しい内容です。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../integration/integration-other-solutions/aam-target-integration.md"> Audience Manager の Target との統合</a> </p> </td> 
   <td colname="col2"> <p>Audience Manager セグメントを Target に送信する方法に関する新しい内容です。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../overview/data-security-and-privacy/data-privacy.md">データのプライバシー</a> </p> </td> 
   <td colname="col2"> <p>内容を修正して、アドビプライバシーセンターへの新しいリンクを追加しました。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/declared-ids.md#declared-id-targeting"> 宣言済み ID のターゲティング</a> </p> </td> 
...
<table id="table_5172A5D65C2841AE8B102B57F00C5FE7"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../features/profile-merge-rules/merge-rule-unsegment.md"> プロファイル結合ルールとデバイスセグメント化解除プロセス</a> </p> </td> 
...
<table id="table_C2E33C099A3F4942AA1BCCC5B7B4D05E"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"><a href="../api/dcs-intro/dcs-api-reference/dcs-error-codes.md"> DCS エラー コード、メッセージ、例</a> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>フォルダー特性を使用すると、同じフォルダーとそのすべての子フォルダーに存在する特性を自動的に集計して、ターゲット設定可能なセグメントにすることができます。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <b><span class="uicontrol">編集</span>ワークフローでは、フォルダー特性のデータソースを変更できます。</b> </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_FB58595763214BB5BBC778733FF0778C"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"><a href="../features/traits/trait-geotarget-keys.md"> プラットフォームレベルのキーによる GeoTargeting（地域に基づくターゲット設定）</a> </td> 
   <td colname="col2"> <p>Geolocation キーのコードを更新しました。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/audience-lab/audience-lab-use-cases.md"> オーディエンスラボのユースケース</a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><span class="keyword">Audience Manager</span> では、複数の異なるタイプおよびソースのモデルを使用できます。<span class="wintitle">オーディエンスラボ</span>を使用することで、アクティブなモデル全体にわたって顧客のコンバージョン率を簡単に比較できます。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/audience-lab/audience-lab-use-cases.md#testing-creatives"> 送信先全体にわたるクリエイティブのテスト</a> </p> </td> 
...
<table id="table_9D6D2244D23648F9AC4D1F5E40BDCF14"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2" morerows="2"> <p>7 日間および 30 日間の振り返り期間は日曜<b><span class="uicontrol">までの</span>日付にのみ使用できることを説明した注意書きを追加しました。</b> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../reporting/audience-optimization-reports/aor-advertisers/unique-user-reach.md"> 個別ユーザーのリーチ</a> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../reporting/audience-optimization-reports/metadata-files-intro/datafiles-intro.md"> オーディエンスの最適化レポートのデータファイル</a> </p> </td> 
...
<table id="table_237E64BBFEF84A8E97EE61E6CD5F371F"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p><a href="../api/dcs-intro/dcs-api-reference/dcs-keys.md"> DCS API 呼び出しでサポートされている属性</a> </p> </td> 
   <td colname="col2"> <p>キー変数の接頭辞に、Audience Manager のプライベートパラメーターを識別する <code>_p</code> を追加しました。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><b><span class="uicontrol">Browse All Traits</span> 詳細検索に、さらに検索およびフィルタリング機能を付け加えました。</b> </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_020B4F263E1C4C55BDF10B15436B0471"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="https://marketing.adobe.com/resources/help/en_US/mcloud/dns-prefetch.html" format="https" scope="external"> 様々な Experience Cloud ソリューションによる DNS プリフェッチの使用</a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><code>DIL.create</code> の <code>containerSNID</code> プロパティの説明を修正し、関連リンクを追加しました。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/addressable-audiences.md#addressable-audience-metrics"> アドレス可能なオーディエンスの指標</a> </p> </td> 
...
<table id="table_8D727AAADA224AF687E41C26CBFB1CC2"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../reporting/audience-optimization-reports/audience-optimization-reports.md"> オーディエンスの最適化レポート</a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../faq/faq-features.md"> 製品の特長と機能の FAQ</a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> 
    <ul id="ul_8EED64687A164BA483A96E6DFABA6690"> 
     <li id="li_EFAB62C108824AF8A56F93433D5259E4"><a href="../integration/receiving-audience-data/batch-outbound-transfers/outbound-template-macros.md"> アウトバウンドテンプレートマクロ</a> </li> 
     <li id="li_9EC8F2B9D03446698C723871F63008F5"><a href="../integration/receiving-audience-data/batch-outbound-transfers/outbound-macro-examples.md"> アウトバウンドマクロの例</a> </li> 
    </ul> </td> 
...
2017 年以前の [!DNL Audience Manager] リリースノートおよびドキュメントの変更点へのリンクです。[!DNL Experience Cloud] レベルの古い変更点のアーカイブについては、[過去のリリースノート](https://marketing.adobe.com/resources/help/en_US/whatsnew/?f=c_legacy_releases.html)を参照してください。
