...
[!DNL Audience Manager] リリースノートおよびドキュメントの変更点へのリンクです。[!DNL Experience Cloud] レベルの古い変更点のアーカイブについては、[過去のリリースノート](https://docs.adobe.com/content/help/ja-JP/release-notes/experience-cloud/current.html)の節を参照してください。
