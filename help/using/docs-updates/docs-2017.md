...
<table id="table_366914EEDA294636A580F706AFC57ACC"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="https://marketing.adobe.com/resources/help/ja_JP/whitepapers/cookies/cookies_am.html" format="https" scope="external"> Audience Manager の Cookie</a> </p> </td> 
...
<table id="table_6AAE9EF4DE76467FAFEDAB418B5A0207"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>For reference purposes, we added the reserved attributes <code> d_dst_filter</code> and <code> d_rs</code> to the documented <code> d_</code> attributes. それらの属性を使用する特性は、作成しないようお勧めします。アドビは、確保している属性をいつでも変更できます。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_020B4F263E1C4C55BDF10B15436B0471"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="https://marketing.adobe.com/resources/help/ja_JP/mcloud/dns-prefetch.html" format="https" scope="external"> 様々な Experience Cloud ソリューションによる DNS プリフェッチの使用</a> </p> </td> 
...
2017 年以前の [!DNL Audience Manager] リリースノートおよびドキュメントの変更点へのリンクです。[!DNL Experience Cloud] レベルの古い変更点のアーカイブについては、[過去のリリースノート](https://marketing.adobe.com/resources/help/ja_JP/whatsnew/?f=c_legacy_releases.html)を参照してください。
