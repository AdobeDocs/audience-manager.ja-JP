...
<table id="table_6AAE9EF4DE76467FAFEDAB418B5A0207"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Audience Manager では、特性選定（特性の満足）の処理方法は特性のタイプによって異なります。このドキュメントでは、特性のタイプごとに絞り込みの詳細を説明しています。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../faq/faq-privacy.md">プライバシーとデータ保持に関するよくある質問</a> </p> </td> 
   <td colname="col2"> <p>特性選定データの保持に関する節を追加しました。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/administration/usage-limits.md"> 使用の制限</a> </p> </td> 
   <td colname="col2"> <p>ここで強調している制限に特性選定の合計数を追加しました。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_5172A5D65C2841AE8B102B57F00C5FE7"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../features/segments/segment-builder-data.md"> セグメントビルダーにおける特性とセグメントの母集団データ</a> </p> </td> 
...
<table id="table_C2E33C099A3F4942AA1BCCC5B7B4D05E"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>フォルダー特性を使用すると、同じフォルダーとそのすべての子フォルダーに存在する特性を自動的に集計して、ターゲット可能なセグメントにすることができます。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>「ユニーク特性実現」と「合計特性母集団」の 2 つの新しい指標が特性概要表示に示されます。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/administration/usage-limits.md"> 使用の制限</a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../features/segments/segment-builder-data.md"> セグメントビルダーにおける特性とセグメントの母集団データ</a> </p> </td> 
   <td colname="col2"> <p>「<span class="wintitle">ユニーク特性実現</span>」の指標を「<span class="wintitle">合計特性母集団</span>」に変更しました。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_9D6D2244D23648F9AC4D1F5E40BDCF14"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Amazon S3 サービスの実稼動環境および Beta 環境の場所に関する情報を追加しました。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="https://experienceleague.adobe.com/docs/core-services/interface/ec-cookies/cookies-am.html?lang=ja" format="https" scope="external"> Audience Manager の Cookie</a> </p> </td> 
   <td colname="col2"> <p>新しい情報に基づき改訂、更新されました。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_237E64BBFEF84A8E97EE61E6CD5F371F"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p><a href="../api/dcs-intro/dcs-api-reference/dcs-keys.md"> DCS API 呼び出しでサポートされている属性</a> </p> </td> 
   <td colname="col2"> <p>Audience Manager のプライベートパラメーターを識別するため、キー変数の接頭辞を <code> _p</code> で更新しました。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/traits/trait-variable-prefixes.md"> キー変数の接頭辞に関する要件</a> </p> </td> 
   <td colname="col2"> <p>Audience Manager のプライベートパラメーターを識別するため、キー変数の接頭辞を <code> _p</code> で更新しました。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_020B4F263E1C4C55BDF10B15436B0471"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>リアルタイムおよび合計セグメント母集団の振り返り期間として 1、14、90 日および無期限を追加しました。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_8D727AAADA224AF687E41C26CBFB1CC2"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>モデル概要ページを更新して、使用可能なモデルの詳細とコントロールの説明を追加しました。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../reference/ids-in-aam.md"> Audience Manager で使用される ID の一覧</a> </p> </td> 
   <td colname="col2"> <p><span class="keyword">Audience Manager</span> で処理されるモバイルデバイス ID（DAID）の想定される形式の説明を追加して更新しました。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><code> DPUUIDS</code> マクロを含めるように更新しました。 </p> </td> 
  </tr> 
 </tbody> 
</table>
