...
<table id="table_A52FC2668EEE4100A71B52267B7215F9"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>テキストを更新し、イラストを追加しました。 </p> <p>このドキュメントは非推奨（廃止予定）となり、プロファイルリンク <a href="../features/profile-merge-rules/merge-rules-overview.md"></a> 置き換えられました。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../features/segments/recency-and-frequency.md"> 最新性と頻度 </a> </p> </td> 
