  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_D4F6BB8E192E4C1BAF1B505541A1E56E"> 
      ...
      <li id="li_85A63519222A4423B8D7A3FF90929741"><code>declaredId</code> 変数に注意書きを追加しました。訪問者 ID サービスを使用する際は、DIL ではなく <code>setCustomerIDs</code> で ID を設定します。詳しくは、<a href="https://marketing.adobe.com/resources/help/ja_JP/mcvid/?f=mcvid_customer_ids.html" format="https" scope="external">顧客 ID と認証状態</a>を参照してください。 </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
