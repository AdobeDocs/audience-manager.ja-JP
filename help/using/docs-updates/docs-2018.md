...
<table id="table_F2018CE3F64E4A1FAA9289EEA17D4E4D"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>2018 年 3 月 29 日（PT）以降、<a href="https://www.ampproject.org/learn/overview/" format="https" scope="external"> Accelerated Mobile Pages</a> （AMP）を利用しているすべてのAudience Managerのお客様は、オーディエンスをGoogleの DoubleClick for Publishers （DFP）に送信する際に、サーバーサイド統合を活用する必要があります。 </p> </td> 
  </tr> 
  <tr> 
