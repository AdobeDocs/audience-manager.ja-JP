...
[!DNL Audience Manager] とその他の [!DNL Experience Cloud] ソリューションの変更点については、[Experience Cloud リリースノート](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/current.html)を参照してください。以前のリリースノートについては、[以前の年度](../docs-updates/docs-2018.md)節を参照してください。
...
<table id="table_01EF3D23C50F4635BFBD55F9D6CE1752"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>バージョン 8.0 より、<span class="wintitle">DIL</span> は、<a href="https://experienceleague.adobe.com/docs/id-service/using/home.html" format="https" scope="external"><span class="keyword">Adobe Experience Platform ID サービス</span></a>のバージョン 3.3 以降に強く依存しています。 </p> </td> 
  </tr> 
  <tr> 
