...
<table id="table_01EF3D23C50F4635BFBD55F9D6CE1752"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../features/audience-lab/audience-lab.md"> オーディエンスラボ</a> </p> </td> 
...
<table id="table_2D7B56FFB0134D18894E0493043C32BD"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>お客様が GDPR リクエストを自動化できるよう、Audience Manager からアクティベーションパートナーに対してセグメント解除（またはセグメント削除）の情報が送信され、データ主体からの削除リクエストが通知されます。 </p> </td> 
  </tr> 
 </tbody> 
</table>
