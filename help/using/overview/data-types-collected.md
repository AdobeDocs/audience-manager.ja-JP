...
|項目|説明||—|—||1|性&#x200B;**別**。 買い物客の名は、通常、その性別を示します。 この例では、買い物客の名はMaryなので、買い物客は女性であることがわかります。 名前はAudience Managerによって保存されることはありません。 ||2|興&#x200B;**味**。 買い物かごの品目は、様々な興味を示す場合があります。 例ではメアリーはフィットネス機器に多くを費やしている。 ||3|住宅&#x200B;**の種類**。 配送先や請求先の住所に基づいて、メアリーが自分用にフィットネス機器を購入したか、会社用にフィットネス機器を購入したかを推測できます。|
|4|**Location**. 郵便番号は、場所を特定する際にIPアドレスよりも信頼性が高くなります。 ||5|プロモーシ&#x200B;**ョンの親和性**。 買い物客がプロモーションコードやギフトカードを使う場合、おそらく最高の取引を探し求めるバーゲンハンターです。 ||6|消費&#x200B;**電力**。 ZIP+4コードと相関する価格データは、所定の場所での支出力を示します。|
