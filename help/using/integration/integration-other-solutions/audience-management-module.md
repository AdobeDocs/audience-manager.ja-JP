...
>[!NOTE]
>
>このページの手順は、[Adobe Digital Tag Manager（DTM）](https://docs.adobe.com/content/help/ja-JP/dtm/using/dtm-home.html)または [Adobe Launch](https://docs.adobe.com/content/help/ja-JP/launch/using/overview.html) を&#x200B;*除く*&#x200B;他のタグ管理ソリューションを使用した実装を示します。Adobe Launch を使用することをお勧めします。[!DNL Launch] を使用すると、このページで示すように、[!UICONTROL AppMeasurement] に手動でコードをコピーする必要がなくなります。
