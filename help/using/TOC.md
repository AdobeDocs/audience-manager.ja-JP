...
+ 機能{#features}
  ...
  + アルゴリズムモデル{#algorithmic-models}
    ...
    + 予測オーディエンス {#predictive-audiences}
      ...
      + [予測オーディエンスの使用の手引き](features/algorithmic-models/predictive-audiences-start.md)
...
+ 実装および統合ガイド{#implementation-integration-guides}
  ...
  + 他のAdobe Experience Cloud アプリケーションとの統合 {#integration-other-solutions}
    ...
    + [Experience CloudへのAdobe Analytics セグメントの公開（Adobe Analytics ドキュメントを開く）](https://experienceleague.adobe.com/docs/core-services/interface/services/audiences/t-publish-audience-segment.html?lang=ja)
...
+ よくある質問（FAQ）{#faqs}
  ...
  + [予測オーディエンスに関する FAQ](faq/faq-predictive-audiences.md)
