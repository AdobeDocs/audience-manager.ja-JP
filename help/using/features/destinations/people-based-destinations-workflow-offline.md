...
| 顧客 ID（DPUUID） | Onboarded Trait ID |
| -------------------------------------- | ------------------- |
| 68079982765673198504052656074456196039 | 12345, 23456 |
| 67412682083411995725538770443620307584 | 45678 |
| 89159024796760343733111707646026765593 | 11223, 93342, 27341 |

<br />上記の例で、対応するオンボーブの特性について顧客IDを修飾するには、[inbound data file]（../../ integration/send- audiences- data/batch- data- transfer- inview/inbound- file- contents. md）を次の内容でアップロードする必要があります。
