...
# データ バイヤー向け[!UICONTROL Audience Marketplace] {#audience-marketplace-for-data-buyers}
...
* **[!UICONTROL Similarity Cutoff]**：スライダーをドラッグして、選択した[!UICONTROL trait]や[!UICONTROL segment]に[!UICONTROL traits]がどれくらい類似しているかに基づいてデータフィードをフィルタリングします。
...
## 類似した[!UICONTROL Traits]を検索しています {#finding-similar-traits}
