---
description: Audience Marketplace では、データプロバイダーとデータ購入者がほとんど手間をかけずにセルフサービス方式でデータを取引できます。役割がデータ購入者かデータ販売者かで異なる専用機能を提供することにより、これを実現しています。実際には、同時に購入者と販売者になることさえできます。これがうまくいかなかった場合、データプロバイダーとセラー間の契約、課金、支払いは Audience Marketplace によって処理されます。
...
開始するには、[!DNL Audience Manager] の営業担当者にお問い合わせください。They can activate [!UICONTROL Audience Marketplace for you].
...
* [データプロバイダー向けの Audience Marketplace の概要](/help/using/features/audience-marketplace/marketplace-data-providers/marketplace-data-providers.md)
