---
description: 管理者以外のユーザーは、電子メールアドレスの変更やパスワードのリセットなど、自分のプロファイルを編集できます。
...
管理者ユーザーは、[ ユーザーの作成](../../features/administration/administration-overview.md#create-users)および[ グループの作成](../../features/administration/administration-overview.md#create-group)で説明しているように、ユーザーを作成し、権限を目的としてグループに追加できます。
