...
| すべてのクロスデバイス対応プロファイル | なし | [People-Based Destinations](../destinations/people-based-destinations-overview.md) のユーザー専用 | バッチのみ | × | [人ベースの宛先のターゲット設定](merge-rule-targeting-options.md#all-cross-device) |
